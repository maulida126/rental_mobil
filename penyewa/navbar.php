...
<nav class="navbar navbar-expand-lg" style="background:#1A1A1A; border-bottom:1px solid #2A2A2A;">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold" href="dashboard.php" style="font-family:'Syne',sans-serif; color:#fff; font-size:1.4rem; letter-spacing:-0.5px;">
            ...
            <span class="badge ms-2" style="background:#3b82f6; font-size:.6rem; vertical-align:middle;">PENYEWA</span>
        </a>
        <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navPenyewa"
                style="color:#777;"><i class="bi bi-list fs-4"></i></button>
        <div class="collapse navbar-collapse" id="navPenyewa">
            <ul class="navbar-nav me-auto gap-1">
                ...
                <li class="nav-item">
                    <a class="nav-link px-3 rounded-3 <?= basename($_SERVER['PHP_SELF']) === 'riwayat.php' ? 'active' : '' ?>"
                       href="riwayat.php" style="color:#aaa;">
                        <i class="bi bi-clock-history me-1"></i>Riwayat Sewa
                    </a>
                </li>
            </ul>
